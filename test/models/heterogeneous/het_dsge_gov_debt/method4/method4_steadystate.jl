...
=#
println("New endogenous grid method, interpolation, Anderson acceleration for Euler iteration and eigenvector approach for Kolmogorov equation")
...
## Check if faster with eigenvector approach now
#=
