...
@testset "Compare eqcond, transition, measurement, and pseudo-measurement matrices against reference matrices" begin
    ...
    @test @test_matrix_approx_eq pseudo_meas[:ZZ_pseudo] Z_pseudo_exp[1:size(pseudo_meas[:ZZ_pseudo], 1), :] # Test files had been generated w/extra pseudo-obs
    @test @test_matrix_approx_eq pseudo_meas[:DD_pseudo] D_pseudo_exp[1:size(pseudo_meas[:DD_pseudo], 1), :] # Test files had been generated w/extra pseudo-obs
end
