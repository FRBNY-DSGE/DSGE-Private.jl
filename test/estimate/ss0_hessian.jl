...
#file_data = "$path/../reference/optimize_in.h5"
#file_mode = "$path/../reference/optimize_in.h5"
...
hessian, _ = hessian!(m, mode, data; hessian_method = :outer_product_gradient, verbose=:none)
...
L2 = norm(expect - actual)
Linf = norm(expect - actual, Inf)
