...
if save_output
    fn = VERSION >= v"1.7" ? "$path/../reference/df_to_table_out_v1p7.jld2" : VERSION >= v"1.6" ? "$path/../reference/df_to_table_out_v1p6.jld2" : VERSION >= v"1.5" ? "$path/../reference/df_to_table_out_v1p5.jld2" : "$path/../reference/df_to_table_out.jld2"
