...
function compute_system!(m::mBBQ, ZLB_duration_1, Fss_ZLB)
    ...
    H_aux, P_ref, Q_ref, HQ, SIGMA_full, SIGMA, ZLB_indicator, ZLB_duration_1, unique_EZLB_duration_1, Ps_aux, Ds_aux, Es_aux, D_ZLB, indicator = DSGE.pq(m, hx, gx, F1_aux, F2_aux, F3_aux, F4_aux, indicator_1, F1_aux_zlb, F2_aux_zlb, F3_aux_zlb, F4_aux_zlb, df, ZLB_duration_1, Fss_ZLB)
