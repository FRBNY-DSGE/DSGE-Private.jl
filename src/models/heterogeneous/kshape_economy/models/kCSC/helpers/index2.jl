...
function build_indices(grid, lenSSS, lenCSS)
    ...
    agg_states = [:R_cb_t, :w_1_t, :w_2_t, :w_t, :A_b_t, :B_b_t, :A_gaux_t, :Q_t, :lev_t, :NW_b_t, 
                  ...
                  :unemp_past_1_t, :unemp_past_2_t, :G_past_t, :LT_past_t, :R_star_t, 
    ...
    summary_controls = [:MRS_t, :A_hh_t, :B_hh_t, :C_t, :N_1_t, :N_2_t, :L_1_t, :L_2_t, 
                        :UB_t, :unemp_1_t, :unemp_2_t, :U_1_t, :U_2_t, :K_t, :B_t, :B_gov_ncp_t, 
                        :T_t, :LT_t, :G_t, :λ_t, :pi_t, :V_1_t, :V_2_t, :J_t, :r_l_1_t, :r_l_2_t, 
                        :v_t, :Y_t, :Profit_t, :r_k_t, :r_a_t, :MC_t, :unemp_t, :n_1_t, :n_2_t, 
                        :M_1_t, :M_2_t, :f_1_t, :f_2_t,:zz_t, :xx_t, :vv_t, :ee_t, :C_b_t, 
                        :Profit_FI_t, :RRa_t, :RR_t, :I_t, :x_k_t]

    observable_controls = [:A_g_obs_t, :Y_obs_t, :C_obs_t, :I_obs_t, :w_1_obs_t, :w_2_obs_t, 
                           :Profit_obs_t, :unemp_1_obs_t, :unemp_2_obs_t, :unemp_obs_t, :pi_obs_t, 
                           :R_obs_t, :w_1_lag_t, :w_2_lag_t, :w_lag_t, :G_obs_t,
                           :YY_lag_t, :CC_lag_t, :II_lag_t, :PPROFIT_lag_t, :uu_1_lag_t, 
                           :uu_2_lag_t, :GG_lag_t, :A_g_lag_t,:l_λ_1_t ,:l_λ_2_t,
