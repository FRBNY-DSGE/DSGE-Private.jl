...
U_1_ind          = idx.U_1_ind;
U_2_ind          = idx.U_2_ind;
Income_Tax_ind   = idx.Income_Tax_ind;
J_bar_1_ind      = idx.J_bar_1_ind;
J_bar_2_ind      = idx.J_bar_2_ind;
...
Income_Tax_aux   = Control_aux(Income_Tax_ind);
J_bar_1_aux      = Control_aux(J_bar_1_ind);
J_bar_2_aux      = Control_aux(J_bar_2_ind);
...
Income_Tax_ss   = Control_ss(Income_Tax_ind);
J_bar_1_ss      = Control_ss(J_bar_1_ind);
J_bar_2_ss      = Control_ss(J_bar_2_ind);
...
% T      = Income_Tax + tau_a*(1-param.Eratio).*(PROFIT);																	

F44_aux(T_ind,end-grid.oc+T_ind)          = (T_aux-T_ss)/perturb_size;
F44_aux(T_ind,end-grid.oc+Income_Tax_ind) = - ( (Income_Tax_aux + tau_a_ss*(1-param.Eratio).*(Profit_ss )) - (Income_Tax_ss + tau_a_ss*(1-param.Eratio).*(Profit_ss)) )/perturb_size;
F44_aux(T_ind,end-grid.oc+Profit_ind)     = - ( (Income_Tax_ss  + tau_a_ss*(1-param.Eratio).*(Profit_aux)) - (Income_Tax_ss + tau_a_ss*(1-param.Eratio).*(Profit_ss)) )/perturb_size;
...
F44_aux(V_1_ind,end-grid.oc+M_1_ind)        = - ( M_1_aux/param.iota_1*J_bar_1_ss - M_1_ss/param.iota_1*J_bar_1_ss )/perturb_size;
F44_aux(V_1_ind,end-grid.oc+J_bar_1_ind)    = - ( M_1_ss/param.iota_1*J_bar_1_aux - M_1_ss/param.iota_1*J_bar_1_ss )/perturb_size;
...
F44_aux(V_2_ind,end-grid.oc+M_2_ind)        = - ( M_2_aux/param.iota_2*J_bar_2_ss - M_2_ss/param.iota_2*J_bar_2_ss )/perturb_size;
F44_aux(V_2_ind,end-grid.oc+J_bar_2_ind)    = - ( M_2_ss/param.iota_2*J_bar_2_aux - M_2_ss/param.iota_2*J_bar_2_ss )/perturb_size;
...
% F44_aux(r_k_ind,end-grid.oc+v_ind)            = 0;
...
F41_aux(n_1_ind,end-grid.os+w_1_ind)           = - ( ((1-param.tau_L)*(1-param.tau_P)*(w_1_aux)^(1-param.tau_P)/param.psi_1)^(param.xi/(1+param.xi*param.tau_P)) - ((1-param.tau_L)*(1-param.tau_P)*(w_1_ss)^(1-param.tau_P)/param.psi_1)^(param.xi/(1+param.xi*param.tau_P)) )/perturb_size;
...
F41_aux(n_2_ind,end-grid.os+w_2_ind)           = - ( ((1-param.tau_L)*(1-param.tau_P)*(w_2_aux)^(1-param.tau_P)/param.psi_2)^(param.xi/(1+param.xi*param.tau_P)) - ((1-param.tau_L)*(1-param.tau_P)*(w_2_ss)^(1-param.tau_P)/param.psi_2)^(param.xi/(1+param.xi*param.tau_P)) )/perturb_size;
