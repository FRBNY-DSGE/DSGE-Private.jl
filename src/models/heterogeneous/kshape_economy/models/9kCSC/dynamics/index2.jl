...
function build_indices_kCSC9(grid, lenSSS, lenCSS)
    ...
    agg_states = [:R_cb_t, :w_1_t, :w_2_t, :w_t, :A_b_t, :B_b_t, :A_gaux_t, :Q_t, :lev_t, :NW_b_t,
                  ...
                  :unemp_past_1_t, :unemp_past_2_t, :unemp_past_t, :G_past_t, :LT_past_t, :R_star_t,
                  :ZZ_1_t, :ZZ_2_t, :ZZ_3_t, :ZZ_4_t, :B_F_t, :Z_t, :ψ_rp_t, :η_t, :D_t, :GG_t,
                  :ι_t, :BB_t, :ψ_w_t, :MP_t, :p_m_t]

    shock_states = [:eps_1_t, :eps_2_t, :eps_3_t, :eps_4_t, :eps_QE_t, :eps_RP_t, :eps_B_F_t, 
                    :eps_BB_t, :eps_Z_t, :eps_G_t, :eps_D_t, :eps_R_t, :eps_iota_t, :eps_eta_t, :eps_w_t]

    # Household aggregate summaries (extended for two types vs. original single-type)
    summary_controls = [:MRS_t, :A_hh_t, :B_hh_t, :C_t,
                        :N_1_t, :N_2_t, :L_1_t, :L_2_t,
                        :UB_t, :unemp_1_t, :unemp_2_t, :unemp_t, :U_1_t, :U_2_t,
                        :Income_Tax_t, :J_bar_1_t, :J_bar_2_t]

    # Production, financial, and matching aggregates
    other_controls = [:K_t, :B_t, :B_gov_ncp_t, :T_t, :LT_t, :G_t, :λ_t, :pi_t,
                      :V_1_t, :V_2_t,
                      :J_t,
                      :r_l_1_t, :r_l_2_t, :v_t, :Y_t, :Profit_t, :r_k_t, :r_a_t, :MC_t,
                      :n_1_t, :n_2_t, :M_1_t, :M_2_t, :f_1_t, :f_2_t,
                      :zz_t, :xx_t, :vv_t, :ee_t, :C_b_t, :Profit_FI_t, :RRa_t, :RR_t, :I_t, :x_k_t]

    observable_controls = [:A_g_obs_t, :Y_obs_t, :C_obs_t, :I_obs_t, :w_1_obs_t, :w_2_obs_t,
                           :w_obs_t, :Profit_obs_t, :unemp_1_obs_t, :unemp_2_obs_t, :unemp_obs_t,
                           :pi_obs_t, :R_obs_t, :w_1_lag_t, :w_2_lag_t, :w_lag_t, :G_obs_t,
                           :YY_lag_t, :CC_lag_t, :II_lag_t, :PPROFIT_lag_t, :uu_1_lag_t,
                           :uu_2_lag_t, :uu_lag_t, :GG_lag_t, :A_g_lag_t, :l_λ_1_t, :l_λ_2_t,
...
function build_ss(param::AbstractDict, SS_stats::AbstractDict)
    ...
    no_log_keys = Set(["P_SS", "P_SS2", "tau_L", "tau_P", "lambda", "pi_bar", "tau_a", "delta_00"])
