function init_observable_mappings!(m::BayerBornLuetticke)
    ...
    observables[:obs_gdpdeflator] = Observable(:obs_gdpdeflator, [:GDPDEF__FRED],
                                               gdpdeflator_fwd_transform,
                                               gdpdeflator_rev_transform,
                                               "GDP Deflator",
    ...
    ############################################################################
    ## 6. Consumption growth per-capita
    ############################################################################
    ...
    # TODO: add other processes Bayer, Born, and Luetticke use
