...
# Estimation changes for ss7:
# (1) Get rid of tfp observable and process (set shock to 0)
# (2) Get rid of consumption growth observable and process (set discount factor shock to 0?)
