...
function write_means_tables_shockdec(m::AbstractDSGEModel, input_type::Symbol,
                                     ...
                                     read_dirname::String = workpath(m, "forecast"),
                                     write_dirname::String = tablespath(m, "forecast"),
                                     use_shockdecseq::Bool = false, use_shockdecqtrs::Bool = false,
                                     kwargs...)
    # Read in necessary MeansBands
    products = use_shockdecqtrs ? [:shockdecqtrs, :trend, :dettrend, :hist, :forecast] : (use_shockdecseq ? [:shockdecseq, :trend, :dettrend, :hist, :forecast] : [:shockdec, :trend, :dettrend, :hist, :forecast])
...
function write_meansbands_tables_all(m::AbstractDSGEModel, input_type::Symbol, cond_type::Symbol,
    ...
    for output_var in output_vars
        ...
        elseif prod in [:shockdec, :shockdecseq, :shockdecqtrs]
            write_means_tables_shockdec(m, input_type, cond_type, class,
...
function add_requisite_output_vars_meansbands(output_vars::Vector{Symbol})
    ...
    if :shockdecpseudo in all_output_vars || :shockdecseqpseudo in all_output_vars || :shockdecqtrspseudo in all_output_vars
        push!(all_output_vars, :histforecastpseudo)
    end
    if :shockdecobs in all_output_vars || :shockdecseqobs in all_output_vars || :shockdecqtrsobs in all_output_vars
