"""
```
write_standard_packet(m, input_type, cond_type,
...
plot_irf_section(fid, m1, m2, input_type1, input_type2,
                 cond_type1, cond_type2; forecast_string1 = "", forecast_string2 = "",
                 which_model = 1, plotroot = "", ncols = 4)
```
